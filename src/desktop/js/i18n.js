// i18n module — extracted from app.js
    const LANG = {
      zh: {
        ...
        fw_unisoc_only: '⚠ 仅支持展锐 UniSoc 平台模组(PAC 协议)',
        ...
        scene_not_supported: '当前平台暂不支持情景模式',
        btn_reboot: '重启模组', btn_factory: '恢复出厂',
        status_modem: '模组', status_data: '数据',
        ...
        label_ant0: 'ANT 0', label_ant1: 'ANT 1',
        ...
        label_5glan_cid: 'CID', label_5glan_vlan: 'VLAN ID',
        ...
        panel_at: 'AT 命令终端', btn_send: '发送', btn_clear_at: '清除', btn_export_at: '导出',
        ...
        label_pa_temp: 'PA 温度', label_modem_sn: '模组 SN',
        toggle_ethernet: 'Ethernet',
        panel_ip: 'IP 地址',
        ...
        ph_plmn_password: '供应商提供', ph_debug_password: '每次连接都需要输入',
        ...
        theme_dark: '深色', theme_light: '浅色', label_app_version: '当前版本',
      ...
      en: {
        ...
        fw_unisoc_only: '⚠ UniSoc platform only (PAC protocol)',
        ...
        scene_not_supported: 'Scene mode is not supported on this platform',
        btn_reboot: 'Reboot', btn_factory: 'Factory Reset',
        status_modem: 'Modem', status_data: 'Data',
        ...
        panel_at: 'AT Terminal', btn_send: 'Send', btn_clear_at: 'Clear', btn_export_at: 'Export',
        ...
        label_pa_temp: 'PA Temp', label_modem_sn: 'Modem SN',
        toggle_ethernet: 'Ethernet',
        panel_ip: 'IP Address',
        label_ipv4: 'IPv4 Address',
        ...
        ph_plmn_password: 'Provided by vendor', ph_debug_password: 'Password is required each time',
        ...
        theme_dark: 'Dark', theme_light: 'Light', label_app_version: 'Version',
